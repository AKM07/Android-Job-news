 ...
 */
public class Login_sekolah extends Activity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.login_sekolah_layout);
    ...
    class AttemptLogin extends AsyncTask<String, String, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Login_sekolah.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Intent ii = new Intent(Login_sekolah.this,News.class);
                    startActivity(ii);
        ...
        protected void onPostExecute(String message) {
            ...
            if (message != null){
                Toast.makeText(Login_sekolah.this, message, Toast.LENGTH_LONG).show();
            }
        }
    }
}
