 ...
 */
public class Login_alumni extends Activity implements OnClickListener{
...
private static final String TAG_MESSAGE = "message";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.login_alumni_layout);
    ...
    class AttemptLogin extends AsyncTask<String, String, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Login_alumni.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Intent ii = new Intent(Login_alumni.this,News.class);
                    startActivity(ii);
        ...
        protected void onPostExecute(String message) {
            ...
            if (message != null){
                Toast.makeText(Login_alumni.this, message, Toast.LENGTH_LONG).show();
            }
        }
    }
    private void logoutUser() {
        ...
        Intent intent = new Intent(Login_alumni.this, Login.class);
